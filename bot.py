#######################################################################################################
#######################################################################################################
## YOU ARE ALLOWED TO COPY PARTS OF THIS CODE AND USE THEM FOR WHATEVER YOU WANT                     ##
## BUT YOU CANNOT COPY THE WHOLE CODE AND MAKE ANOTHER DISCORD BOT WITH IT                           ##
## DOING THAT WILL GET YOU AND YOUR BOT BANNED ON THOUSANDS OF SERVERS                               ##
#######################################################################################################
## YOU CAN INVITE THIS BOT WITH THE LINK BELOW:                                                      ##
##                                                                                                   ##
## https://discordapp.com/oauth2/authorize?client_id=453210408384462848&scope=bot&permissions=8      ##
#######################################################################################################
## FOR MORE INFORMATION JOIN THE SUPPORT SERVER: https://discord.gg/geVrByH                          ##
#######################################################################################################
#######################################################################################################

print("Starting pixel Fun...")
import discord
...
help1 += "\nxf!eightball <yes/no question>"
help1 += "\n-    Answers yes-no questions."
help1 += "\nxf!pfp"
help1 += "\n-    Gives you a random user's profile picture."
help1 += "\nxf!calculator <math problem>"
help1 += "\n-    Solves simple math problems."
help1 += "\nxf!battle <user>"
help1 += "\n-    Use this to fight someone."
help1 += "\nxf!ship <something> | <something else>"
help1 += "\n-    Makes lovely ships."
help1 += "\nxf!rps <rock/paper/scissors>"
...
help1 += "\nxf!lettergen <number of letters>"
...
help5 += "\nxf!umsg <user ID> <text>"
help5 += "\n-    Sends a message to a user."
help5 += "\nxf!smsg <server ID> <text>"
help5 += "\n-    Sends a message to a server owner."
help5 += "\nxf!close <ticket number>"
help5 += "\n-    Closes a ticket."
help5 += "\nxf!link <server ID>"
