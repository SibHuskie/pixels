...
warns = []
muted_list = []
owner_roles = ["399953350667272204", "438324581049303040", "299761993382887425", "527373834618273803"]
manager_roles = ["313239786766729226", "363935785574989825"]
admin_roles = ["392534402057371648", "425100698498367488"]
mod_roles = ["390740559569879042", "414064772867293184", "456733945099452416"]
helper_roles = []
muted_roles = []
logs = []
...
async def mod(ctx, target = None):
    ...
    if len(started) == 0:
        ...
        if author.id == '299761993382887425':
            if target == None:
